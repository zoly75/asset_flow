...
SECRET_KEY = 'django-insecure-n!yg&*lz^4amve@p#n=#px3#3c7gkyzbix=d=2zy81&#kuku@w'
...
# Redirect users here after a successful logout
LOGOUT_REDIRECT_URL = 'login'

# The URL where the login page is located.
